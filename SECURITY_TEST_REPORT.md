# 安全测试报告 — YOLO Object Counter v2.1.0
...
**涉及文件**：`objcounter/routes/models.py` 第 33-46 行
...
**涉及文件**：`objcounter/guard.py` 第 10-60 行
...
**涉及文件**：
- `objcounter/routes/models.py` 第 33 行 — `/api/select-model`
- `objcounter/routes/pages.py` 第 54-76 行 — `/api/valuable-toggle`、`/api/valuable-reset`、`/api/valuable-open-dir`
...
**涉及文件**：`objcounter/valuable.py` 第 76-78 行
...
**涉及文件**：`objcounter/middleware.py` 第 25-27 行
...
**涉及文件**：`objcounter/routes/admin.py` 第 56-62 行
